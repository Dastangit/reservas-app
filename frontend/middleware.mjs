// Vercel Routing Middleware — Markdown Negotiation for AI agents
...
const HOW_IT_WORKS_MD = `# How It Works — Elysio Experiences
...
const FAQ_MD = `# Frequently Asked Questions — Elysio Experiences
